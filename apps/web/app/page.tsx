...
export default function Page() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-100 via-gray-50 to-white text-gray-800 overflow-x-hidden">
      {/* HEADER */}
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-full h-full">
          ...
          <div className="absolute bottom-20 right-20 w-96 h-96 bg-gray-400/20 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              {/* Coming Soon Message */}
              <div className="bg-gradient-to-r from-red-50 to-red-100 border-2 border-red-200 rounded-xl p-6 mb-10 shadow-lg">
            ...
            <motion.div 
              ...
              className="relative"
            >
              <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-3xl p-8 shadow-2xl border border-gray-300">
                <div className="grid grid-cols-2 gap-4">
                  {SERVICES.slice(0, 4).map((service, index) => (
                    <motion.div 
                      key={service.key}
                      whileHover={{ scale: 1.05 }}
                      className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all cursor-pointer border border-gray-200"
                    >
      ...
      {/* SERVICES SECTION */}
      <section id="servicios" className="py-20 bg-gradient-to-br from-gray-200 to-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            initial={{ opacity: 0, y: 30 }}
      ...
      {/* PROCESS SECTION */}
      <section id="proceso" className="py-20 bg-gradient-to-br from-gray-300 to-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {STEPS.map((step, index) => (
              <motion.div 
                ...
                className="relative"
              >
                <div className="bg-white rounded-2xl p-8 shadow-lg h-full border border-gray-200">
      ...
      <footer className="py-8 bg-black text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-2xl font-bold text-red-600 mb-4 md:mb-0">
              <Image 
                src="/images/logo-inspecten.png" 
                alt="INSPECTEN Logo" 
                width={120} 
